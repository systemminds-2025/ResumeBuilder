                                ...
                                {data.certificates.map((cert, index) => (
                                    <div key={index}>
                                        <div className="flex justify-between items-center mt-3">
                                            <h3 className="font-semibold text-zinc-900">{cert.title}</h3>
                                            <span className="text-xs text-zinc-500">{cert.date}</span>
                                        </div>
                                        <p className="text-sm" style={{ color: accentColor }}>{cert.issuer}</p>
                                        {cert.description && <p className="text-sm text-zinc-700 mt-1">{cert.description}</p>}
                                    </div>
                                ))}
                            </div>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                {data.achievements.map((achievement, index) => (
                                    <div key={index}>
                                        <div className="flex justify-between items-center mt-3">
                                            <h3 className="font-semibold text-zinc-900">{achievement.title}</h3>
                                            <span className="text-xs text-zinc-500">{achievement.date}</span>
                                        </div>
                                        {achievement.description && <p className="text-sm text-zinc-700 mt-1">{achievement.description}</p>}
                                    </div>
                                ))}
                            </div>
                        </section>
