...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
    ...
    const templates = [
        ...
        },
        {
            id: "executive",
            name: "Executive",
            preview: "Professional two-column layout ideal for senior positions and executive roles"
        },
        {
            id: "academic",
            name: "Academic",
            preview: "Traditional academic CV format with emphasis on education and research"
        },
        {
            id: "ats",
            name: "ATS Friendly",
            preview: "ATS-optimized format with clean structure and keyword-friendly design"
        },
        {
            id: "ats-compact",
            name: "ATS Compact",
            preview: "Ultra-compact ATS format with dense layout ideal for experienced professionals"
        },
    ]
    return (
